...
const terraform_files_2 = require("./terraform_files");
...
game2.getPlayer("Mark")?.buyCard(terraform_files_2.cardList.card004).buyCard(terraform_files_2.cardList.card009);
...
game2.getPlayer("Steve")?.buyCard(terraform_files_2.cardList.card002);
game2.getPlayer("Mark")?.buyCard(terraform_files_2.cardList.card003);
